            ...
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
                <a href="{{ route('section.edit' ,['section' => $section->id] ) }}">
                    <button
                        ...
                        {{ __('Dashboard.Back to Section') }}

                    </button>
                </a>

                    <form class="py-12 mr-1/4" action="{{ route('question.store' , ['section' => $section->id]) }}" method="POST">
                        @method('POST')
                        @csrf
